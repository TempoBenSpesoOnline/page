...
Output2 += `  <body>
    ...
    <form data-netlify="true" name="submission" data-netlify-recaptcha="true" method="POST">
      ...
      <label>Cliccando questa <em>checkbox</em>, confermo che il contenuto del suggerimento non comprende contenuto pornografico o comunque inadatto ai minori. <input type="checkbox" name="a-nsfw" required /></label><br>
