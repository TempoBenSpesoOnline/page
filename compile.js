...
Output2 += `  <body>
    ...
    <form data-netlify="true" name="submission" data-netlify-recaptcha="true" method="POST">
      ...
      <label>Cliccando questa <em>checkbox</em>, capisco che il mio suggerimento non appare immediatamente ma verrá passato da una verifica. <input type="checkbox" name="a-verification" required /></label><br>
      <label>Cliccando questa <em>checkbox</em>, confermo che il contenuto del suggerimento non comprende contenuto pornografico, violento o comunque inadatto ai minori. <input type="checkbox" name="a-nsfw" required /></label><br>
      <label>Cliccando questa <em>checkbox</em>, confermo che il contenuto del suggerimento é in italiano. <input type="checkbox" name="a-italian" required /></label><br>
      <label>Cliccando questa <em>checkbox</em>, confermo che il contenuto del suggerimento é lo stesso che ho descritto. <input type="checkbox" name="a-real" required /></label><br>
      <label>Cliccando questa <em>checkbox</em>, confermo che il contenuto del suggerimento é pubblicamente disponibile. <input type="checkbox" name="a-public" required /></label><br>
      <label>Cliccando questa <em>checkbox</em>, confermo che il contenuto del suggerimento é accessibile gratuitamente <input type="checkbox" name="a-free" required /></label><br>
      <label>Cliccando questa <em>checkbox</em>, confermo che il aprire/utilizzare il link del suggerimento non mi porta guadagni o comunque benefici. (questo non include ovviamente i siti di tua proprietá) <input type="checkbox" name="a-nsfw" required /></label><br>
